...
urlpatterns = [
    ...
    path('api/v1/categories/', views.category_list_with_count),
    ...
    path('api/v1/categories_with_count/', views.category_list_with_count),
    path('api/v1/products_with_reviews/', views.product_list_with_reviews_and_rating),
]
